...
byte MAC[6] = { 0x8C, 0x4C, 0xAD, 0xF0, 0xBF, 0x27 };
...
const char _ledTrggringMOSFETPin_2 = PB3;
...
const byte scaleStepForAutoBrightnessEEPROMAdd = 35;
const byte totalLightLuxIntEEPROMAdd = 36;
const byte totalLightLuxFloatEEPROMAdd = 37;
const byte additionalLuxInpercentageEEPROMAdd = 38;

int ethernetResetCounter = 0;
byte analogPulseMaxDutyCycle = 255;
...
unsigned int userDefinedLux = 1100;
...
byte luxConfirmationCounter = 0;
float requiredintensityFromLight = 0.0;
byte scaleStepForAutoBrightness = 20;

unsigned int totalLuxOfLight = 1000;
byte additionalLuxInpercentage = 0;
